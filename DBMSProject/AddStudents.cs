        ...
        private void buttonSignup_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        cmd = new SqlCommand("insert into EMS_User(Username,Email,Password,DOB,Gender,RoleId,DeptId)  values ('" + textBoxName.Text + "','" + textBoxEmail.Text + "','" + textBoxPassword.Text + "','" + dateTimePickerDOB.Text + "','" + gender + "','" + 3 + "',"+deptId+")", con);
                        cmd.ExecuteNonQuery();
